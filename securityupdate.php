...
<div class="container">
  ...
  <div class="jumbotron">
    ...
    <form class="adminform" action="" method="post" name="login">
      <fieldset><legend><h2><h2>Update Security Guards</h2></legend>
...
if (isset($_POST['push'])) {
  ...
  $password = mysqli_real_escape_string($con,$password);
	...
	if($result)
	{
                ...
                echo "<script type='text/javascript'>alert('Your update was successful!!'); document.location.href = 'viewsecurity.php';</script>";
	}
